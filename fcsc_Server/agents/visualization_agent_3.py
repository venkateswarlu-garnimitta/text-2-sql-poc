...
{{
  ...
  - dont give any headings and bold letters and also dont enclose words in quotes for highlight.
  - Keep language neutral, professional, and positive.
  - No negative, sensitive, biased, or personal commentary.
  - Use correct grammar and spelling.
  - No unnecessary repetition.
  - Use Million AED formatting like all the units are represented in Million AED currency so use appropriate formatings to make it looking good.
